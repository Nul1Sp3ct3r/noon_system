  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const dto = {
        ...
        // referenceNumber is auto-generated by the backend — never sent from the form
      ...
      {showForm && (
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 items-start">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-slate-600 mb-1">الرقم المرجعي</label>
                    {editId && form.referenceNumber ? (
                      <div className="input w-full font-mono bg-slate-100 text-slate-600 select-all cursor-text">
                        {form.referenceNumber}
                      </div>
                    ) : (
                      <div className="input w-full text-slate-400 bg-slate-50 italic text-xs flex items-center">
          ...
          <div className="xl:col-span-1 space-y-3 xl:sticky xl:top-20">
            ...
            {/* Auto-ref badge — shows after edit opens an existing record */}
            {editId && form.referenceNumber && (
              <div className="bg-slate-800 rounded-xl px-4 py-3 flex items-center justify-between shadow-sm">
                <span className="text-[10px] text-slate-400 uppercase tracking-wide">الرقم المرجعي</span>
